...
読み込んだデータセットをCNNに投げる。
２０１６年２月２３日時点で畳み込み層１，プーリング層１、全結合層１
"""
...
if __name__ == '__main__':
    ...
    for i in range(epoch_size):
        ...
        if i%100 == 0:
            ...
            print("epoch:%d loss:%f"%(i, sess.run(loss, feed_dict={x: batch_x, y_: batch_y})))
    #test 
    print("test loss:", sess.run(loss, feed_dict={x: input_data.test_data, y_: input_data.test_target }))
    d = datetime.datetime.today()
    print("終了時刻:", d.strftime("%Y-%m-%d %H:%M:%S"))
